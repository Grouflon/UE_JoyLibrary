...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Joy|Debug", meta = (WorldContext = "_worldContextObject")) static bool IsPlayInEditor(UObject* _worldContextObject);
