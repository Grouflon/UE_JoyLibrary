...
JOYLIBRARY_API void DampSpring(FQuat& _v0, const FQuat& _target, FQuat& _vel, float _time90, float _dt);

USTRUCT(BlueprintType)
struct JOYLIBRARY_API FSmootherFloat
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct JOYLIBRARY_API FSmootherVector
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct JOYLIBRARY_API FSmootherRotation
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class JOYLIBRARY_API USmoother : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
